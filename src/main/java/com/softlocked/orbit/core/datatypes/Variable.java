...
public class Variable {
    ...
    public static long getSize(Object obj) {
        ...
        else if (obj instanceof OrbitObject orbitObject) {
            return orbitObject.getSize();
        }
        else if (obj instanceof Integer) return Integer.BYTES;
        else if (obj instanceof Float) return Float.BYTES;
        else if (obj instanceof Double) return Double.BYTES;
        else if (obj instanceof Long) return Long.BYTES;
        else if (obj instanceof Byte) return Byte.BYTES;
        else if (obj instanceof Short) return Short.BYTES;
        else if (obj instanceof Character) return Character.BYTES;
        else if (obj instanceof Boolean) return Byte.BYTES;
        else if (obj instanceof String string) return (long) string.length() * Character.BYTES;
        ...
        else if (obj instanceof Coroutine coroutine) {
            return coroutine.getSize();
        }
